...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="../ventas" class="logo d-flex align-items-center">
        ...
        <span><?php print($NombreComercio); ?> | Historial </span>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
        <li><a class="getstarted scrollto" style="background: red;" href="../Ventas"><i class="ri-shopping-basket-line"></i>&nbsp;Ir a ventas</a></li> 
  ...
  <!-- ======= Counts Section ======= -->
    <section id="counts" class="counts" style="margin-top:-3%;">
      <div class="container" data-aos="fade-up">

        <div class="row gy-4">
        <?php require('../Ventas.php'); ?>
      </div>
    </section><!-- End Counts Section -->
    <!-- ======= Services Section ======= -->
    <section id="contact" class="contact" style="margin-top:-3%;">
    <div class="container" data-aos="fade-up">
        ...
        <tbody id="myTable">
            ...
            ?>
                <tr>
                    ...
                    <td><a class="btn btn-info" href="../TICKETS/ticket_VF.PHP?Tk=<?php echo $row['IdVenta']; ?>" target="_blank"><i class="ri-ticket-2-fill"></i></a></td>
                </tr>
            <?php
            }
            ?>
