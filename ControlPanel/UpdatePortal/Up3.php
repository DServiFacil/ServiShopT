...
$sql = "SELECT * FROM CatSubMenus where IdSubMenu = '$ClaveElement'";
$resultado = sqlsrv_query($con, $sql);
$row = sqlsrv_fetch_array($resultado);

$IdSubMenu = $row['IdSubMenu'];
$NomSubMenu = $row['NomSubMenu'];
$Link = $row['Link'];
?>
<head>
    <!-- Required meta tags -->
...
<div class="card">
   ...
   <form action="Level3.php" method="POST" class="login-email" enctype="multipart/form-data" >
   <div class="input-group">
   <input type="hidden" aria-label="Last name" class="form-control" name="IdSubMenu" placeholder="IdGrupo" value="<?php print($IdSubMenu) ?>">
          <span class="input-group-text">Grupo</span>
          <input type="text" aria-label="Last name" class="form-control" name="NomSubMenu" placeholder="Grupo" value="<?php print($NomSubMenu) ?>">
          &nbsp;&nbsp;&nbsp;&nbsp;
          </br>
