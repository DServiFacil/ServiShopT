...
$sql = "SELECT * FROM CatGruposPrincipales where IdGrupo = '$ClaveElement'";
...
<div class="card">
   ...
   <form action="Level1.php" method="POST" class="login-email" enctype="multipart/form-data" >
   <div class="input-group">
   <input type="hidden" aria-label="Last name" class="form-control" name="IdGrupo" placeholder="IdGrupo" value="<?php print($IdGrupo) ?>">
          <span class="input-group-text">Grupo</span>
          <input type="text" aria-label="Last name" class="form-control" name="Grupo" placeholder="Grupo" value="<?php print($Grupo) ?>">
          &nbsp;&nbsp;&nbsp;&nbsp;
