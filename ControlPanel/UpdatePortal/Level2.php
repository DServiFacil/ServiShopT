...
<?php
  ...
  $IdGrupSec = $_POST['IdGrupSec'];
	$GrupoSecundario = $_POST['GrupoSecundario'];
    $Link = $_POST['Link'];
	$sql1 = "UPDATE [dbo].[CatGruposSecundarios] SET GrupoSecundario='$GrupoSecundario', Link= '$Link', FechaUpdate = '$F_Update' where IdGrupSec = '$IdGrupSec' ";
...
<a >Diseñado por TI Operaciónes Aceria Celaya</a>
				...
				<META HTTP-EQUIV="REFRESH" CONTENT="1;URL=../UpdatePortal">
