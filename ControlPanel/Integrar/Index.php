                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Añadir Nuevo elemento</h2>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">BLOQUE SSYS</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
...
<div class="card">
   ...
   <form action="up1.php" method="POST" class="login-email" enctype="multipart/form-data" >
   <div class="input-group">
          ...
          <input type="text" aria-label="Last name" class="form-control" name="Link" placeholder="Liga de SharePoint: EJEMPLO https://deacero0.sharepoint.com/sites/PACC/SSYS etc." value="<?php print($Grupo) ?>">          
          &nbsp;&nbsp;&nbsp;&nbsp;

          </br>
          <div class="d-grid gap-2">
             <button class="btn btn-outline-danger" type="submit">Añadir</button>
          </div>
          </br>
        </form>
    </div>
...
<div class="card">
    ...
    <table class="table" style=" height: 50%; overflow-y: auto;">
        ...
        <tbody class="BusquedaRapida">
            <?php
            $consulta = "SELECT * from [dbo].[CatGruposPrincipales] cg inner join users us on cg.IdUsuario = us.IdUsuario";
            $resultado = sqlsrv_query($con , $consulta);
            $contador=0;
