...
<?php
    ...
    $FechaUpdate = date("m/d/Y H:i:s a");
    $Grupo = $_POST['Grupo'];
    $Link = $_POST['Link'];
    $IdUsuario = $ClaveActiva;

      $sql="UPDATE  [CatGruposPrincipales] SET Grupo = '$Grupo', Link = '$Link', FechaUpdate = '$FechaUpdate', IdUsuario= '$IdUsuario' where IdGrupo = $ID";
       $recurso=sqlsrv_prepare($con,$sql);
...
<a >Diseñado por TI Operaciónes Aceria Celaya</a>
				...
				<META HTTP-EQUIV="REFRESH" CONTENT="1;URL=../Integrar/">
