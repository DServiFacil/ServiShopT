...
$sql = "SELECT * FROM catproductos where IdTipoProducto = '$ClaveUser'";
$resultado = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($resultado);

$clave = $row['IdTipoProducto'];
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Actualizar Producto: <?php print($TipoProducto) ?></h4>
    </div>
    <div class="card-body">
   <div class="table-responsive">
   <form action="Update_Product_Eject.php" method="POST" class="login-email" enctype="multipart/form-data" >
   <div class="input-group">
   <input type="hidden" aria-label="Last name" class="form-control" name="IdTipoProducto" placeholder="IdTipoProducto" value="<?php print($clave) ?>">
          <span class="input-group-text">Nombre</span>
          <input type="text" aria-label="Last name" class="form-control" name="TipoProducto" placeholder="TipoProducto" value="<?php print($TipoProducto) ?>">
          &nbsp;&nbsp;&nbsp;&nbsp;
          <span class="input-group-text">Costo Kg</span>
          <input type="text" aria-label="Last name" class="form-control" name="PrecioKg" placeholder="PrecioKg" value="<?php print($PrecioKg) ?>">
         </div>
         </br>
...
<div class="card">
    ...
    <div class="card-body">
    <div class="table-responsive">
    <?php include '../../Tabla_Productos_2.php' ?>
      </table>
                </div>
    </div>
</div>
