...
$sql = "SELECT * FROM clientes where IdCliente = '$ClaveUser'";
$resultado = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($resultado);

$clave = $row['IdCliente'];
$NombreCliente = $row['NombreCliente'];
$estatusCliente = $row['estatusCliente'];
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Actualizar Cliente: <?php print($TipoProducto) ?></h4>
    </div>
    <div class="card-body">
   <div class="table-responsive">
   <form action="Update_Cliente_Eject.php" method="POST" class="login-email" enctype="multipart/form-data" >
   <div class="input-group">
   <input type="hidden" aria-label="Last name" class="form-control" name="IdCliente" placeholder="IdTipoProducto" value="<?php print($clave) ?>">
          <span class="input-group-text">Nombre</span>
          <input type="text" aria-label="Last name" class="form-control" name="NombreCliente" placeholder="Cliente" value="<?php print($NombreCliente) ?>">
          &nbsp;&nbsp;&nbsp;&nbsp;
    <label class="input-group-text" for="estatusCliente">Estatus del Cliente</label>
    <select class="form-select" id="estatusCliente" name="IdEstatusProducto">
        <option value="1" <?php if ($estatusCliente == 1) echo 'selected'; ?>>Activo</option>
        <option value="2" <?php if ($estatusCliente == 2) echo 'selected'; ?>>Inactivo</option>
    </select>
</div>
         </br>
...
<div class="card">
    ...
    <div class="card-body">
    <div class="table-responsive">
    <?php include '../../Tabla_Clientes_2.php' ?>
      </table>
                </div>
    </div>
</div>
