...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE cajainicial SET TotalMonto = '$MontoTotal', IdUsuario = '$IdUsuario' WHERE IdMonto = 1";
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Panel de control | Caja</h2>
    ...
    <div class="card-header">
        <h4 class="card-title">Modificar Caja Inicial</h4>
    </div>
    <div class="card-body">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            <label for="tipoProducto">Monto:</label>
            <input type="text" class="form-control" id="MontoTotal" name="MontoTotal" value="<?php print($TotalMonto); ?>" required>
        </div>
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Caja Inicial</h4>
    </div>
    <div class="card-body">
    <div class="table-responsive">
                    <?php include '../../Tabla_Caja.php' ?>
                </div>
    </div>
</div>
</div>
