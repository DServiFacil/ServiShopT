...
<?php
	...
	$sql1 = "UPDATE dbo.EstatusSeguridad SET  FechaRegistro='$F_Update', IdSemaforo = '$IdSemaforo', IdUsuario = '$ClaveActiva' where IdSeguridadSem = '1' ";
...
<?php
	...
	$sql2 = "UPDATE dbo.FechaEventos SET  FechaEvento='$Fecha_2', IdUsuario = '$ClaveActiva' where IdFecha = '1' ";
